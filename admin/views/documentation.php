...
<div class="livemesh-doc">
    ...
    <div class="intro-wrap">
        ...
        <img class="plugin-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/plugin-screenshot.jpg" alt="Addons for Beaver Builder">
    ...
    <div class="panels">
        ...
        <div id="panel" class="panel">
            ...
            <div id="help-panel" class="panel-left visible">
                ...
                <p>Thanks for choosing Addons for Beaver Builder plugin. This help file aims to provide you with all the information you need to make the best use of this powerful plugin. The aim of the plugin to make the task of building a website effortless and pleasurable. Towards that end, we have built a number of elements most commonly used across most of the websites of small businesses, corporates, design agencies, freelancers, artists etc.</p>
                ...
                <ol>
                    ...
                    <li><strong>Make sure you deactivate the free plugin</strong> <a href="https://wordpress.org/plugins/addons-for-beaver-builder/" rel="nofollow">Addons for Beaver Builder</a> upon installing the premium version.
                    </li>
                    ...
                    <li>Optionally, if you have <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin installed, you can import the sample data
                ...
                <p>Below is a list of required/recommended plugins to install that will help you get the most out of this plugin.
                    ...
                    provided with the <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/"
                                         title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of
                ...
                <ul>
                    <li><p><strong>Beaver Builder</strong> is perhaps the most loved page builder tool for WordPress powering
                        ...
                        <p>All of the elements part of Addons for Beaver Builder plugin were built using the API provided
                ...
                <h3 id="demo-data">Installing Demo Data<a class="back-to-top" href="#panel"><span
                                class="dashicons dashicons-arrow-up-alt2"></span> Back to top</a></h3>
                <p>If you have <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin installed, you can install the demo data to replicate the
                ...
                <ul>
                    ...
                    <li>Once the Addons for Beaver Builder plugin is activated, you should see a menu item <strong> <a href="<?php echo admin_url() . 'admin.php?page=livemesh_bb_addons'; ?>"
                    ...
                    <li>Once the Addons for Beaver Builder plugin is activated, all of the elements built by the plugin become available for drag and drop in the frontend Beaver Builder. In
                    ...
                    <li>Many of the plugin elements part of this plugin are container elements that involve a child element to be added to the it. For eg., Team element needs multiple team member elements
                        ...
                        <p>The container elements are listed under 'Livemesh Addons' tab in the 'Add Content' popup screen. Once you add a container element (e.g., Livemesh Testimonials,
                            Livemesh Servies, Livemesh FAQ, Livemesh Features, Livemesh Team etc.), the element edit popup window has button control to add child elements. Clicking on the add button
                ...
                <p>The below sections provide help on each of the elements built as part of Addons for Beaver Builder
                    plugin.</p>
                ...
                <p>The element supports about 3 different styles (with 2 additional styles in <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the
                ...
                <p>The <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin allows you specify a custom font size, font color and and hover
                ...
                <p>Two different styles are provided with more styles planned in the <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin. Most
                ...
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid.jpg" alt="Livemesh Grid Addon"></p>
                ...
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid2.jpg" alt="Livemesh Grid Addon"></p>
                ...
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid-pagination.jpg" alt="Livemesh Grid Pagination"></p>
                <p>The <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Addons for Beaver Builder Pro" target="_blank">premium version</a> of the plugin has support for pagination, lazy load with load more button and
                ...
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid-loadmore.jpg" alt="Livemesh Grid AJAX Load More"></p>
                ...
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid-edit1.png" alt="Livemesh Grid Edit Window"></p>
                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid-edit2.png" alt="Livemesh Grid Edit Window"></p>

                <p><img class="alignnone size-large" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/livemesh-grid-edit3.png" alt="Livemesh Grid Edit Window"></p>
                ...
                <p>The element options are mostly self-explanatory and you can view a live preview of the buttons <a
                            ...
                            href="https://www.livemeshthemes.com/beaver-builder-addons/buttons/">here</a>.</p>
                ...
                <p>It can be used to create a gallery of videos uploaded to YouTube/Vimeo – useful for video bloggers,
                    ...
                    as seen in this <a title="Video Gallery"
                                       href="https://www.livemeshthemes.com/beaver-builder-addons/video-gallery/">demo page</a>.
                </p>
            ...
            <div id="updates-panel" class="panel-left">
                ...
                <h3>1.2.1</h3>
                <ul>
                    <li>Fixed - Undefined pagination property warning for Livemesh Grid Beaver addon</li>
                </ul>
                <h3>1.2</h3>
                <ul>
                ...
                <h3>1.1</h3>
                <ul>
                    <li>Updated documentation. Preparation for moving entire documentation online.</li>
                </ul>
                <h3>1.0</h3>
                <ul>
            ...
            <div class="panel-right">
                ...
                <div class="panel-inner">
                    ...
                    <div class="panel-aside banner">
                        <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Purchase Now"><img class="dashboard-image"
                    ...
                    <div class="panel-aside">
                        ...
                        <p><?php _e('Premium version offers multiple benefits - more addon elements, advanced features for addons including those part of the free plugin and priority support through a dedicated support forum.', 'livemesh-bb-addons'); ?></p>

                        <a class="button button-primary"
                           href="<?php echo admin_url() . 'admin.php?page=livemesh_bb_addons_pro_upgrade'; ?>"
