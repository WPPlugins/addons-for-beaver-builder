...
<div class="livemesh-doc">
        ...
        <div id="plans" class="content-wrapper clear">
            <div class="plans-wrapper clear">
                <div class="plan-intro">
                    <div class="w100 clear"><img src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/logo-light.png" class="mb30">
                        <p>A huge collection of Premium addons for Beaver Builder. Building a beautiful website is as easy as drag and drop.</p></div>
                </div>
                <div class="plans">
                    <div class="content-wrapper flex-wrap">
                        <div class="plan plan1 even flex-col">
                            <div class="w100 clear"><h3>Lite</h3>
                                ...
                                <div class="action clear"><a href="https://wordpress.org/plugins/addons-for-beaver-builder/" class="btn bg-gr center" title="Addons for Beaver Builder Download">Download now</a></div>
                            </div>
                        </div>
                        <div class="plan plan2 flex-col">
                            <div class="w100 clear"><h3>Premium</h3>
                                ...
                                <div class="action clear"><a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" class="btn center bg-cy">Purchase Now</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>Exquisitely designed premium quality addons for Beaver Builder Page Builder.</div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">Page Builder Elements</div>
                            <div class="tooltip hide">
                                <div><p>Large collection of plugin addons with their multiple styles are page builder elements that provide ALL the tools you need to come up with a dream website of yours by just drag, drop and configure. &nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                        ...
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>The PRO version comes with advanced grid functions like pagination, lazy load via AJAX, lightbox support etc.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/portfolio-grid-pro/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                        ...
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>Multiple pages of posts/portfolio/image/video grid loaded inline without page refresh. Showcase your entire work anywhere on the site.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/portfolio-grid-pro/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">Advanced Grid with Lazy Load</div>
                            <div class="tooltip hide">
                                <div><p>The grid elements are loaded on demand with each press of a Load More button that displays a count of remaining posts.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/portfolio-grid-pro/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                        ...
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>Responsive slider with choice of Nivo, Flex, Slick and Ultra Lightweight slider types. Comes with multiple caption styles, thumbnail navigation and detailed customization of slider speed and controls.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/livemesh-sliders/">Live Demo</a></p>
                                </div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>Create a beautiful yet responsive gallery with support for tagging, linking, filtering, labels, lazy load of images with Load More and pagination.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/image-gallery/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">YouTube/Vimeo Video Gallery</div>
                            <div class="tooltip hide">
                                <div><p>Essential tool for video bloggers, video marketers, musicians and other sites with video content. Tags, filters, external linking, labels, pagination and lazy load via AJAX supported.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/video-gallery/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">Advanced Image Carousel</div>
                            <div class="tooltip hide">
                                <div><p>Advanced carousel with touch/swipe/drag/paged/click navigation. Extensive customization for responsiveness, animation/slideshow speed, gutter, looping etc.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/gallery-carousel/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">YouTube/Vimeo Video Carousel</div>
                            <div class="tooltip hide">
                                <div><p>Perfect for showcasing a select collection of videos with filters, tags, external links, labels, touch/swipe/mouse drag/click navigation, paging and lightbox support.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/gallery-carousel/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">Features List</div>
                            <div class="tooltip hide">
                                <div><p>List the product features or services offered in style.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/features/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                        ...
                        <div class="plan plan1 even"><h4>Lite</h4>
                            <ul>
                                <li>
                                    ...
                                    <div class="tooltip hide">
                                        <p>Exquisitely designed premium quality addons for Beaver Builder Page Builder.</p>
                                    </div>
                                </li>
                                <li>
    ...
    <img style="max-width:100%;padding-top: 50px;" class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/why-premium.jpg" alt="Why Choose Premium">

    <div class="button-wrap">

        <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Purchase Now">

            <img class="button-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/purchase-button.png" alt="Purchase Button">
    ...
    <div class="panels">
        ...
        <div id="panel" class="panel">
            ...
            <div id="upgrade-panel" class="panel-left visible">
                    ...
                    <p>
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/image-slider.jpg" alt="Image Slider">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/advanced-grid.jpg" alt="Advanced Grid">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/image-gallery.jpg" alt="Image Gallery">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/video-gallery.jpg" alt="Video Gallery">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/image-video-carousel.jpg" alt="Image Video Carousel">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/more-premium.jpg" alt="More Premium Goodness">
                        <img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/priority-support.jpg" alt="Priority Support">

                       </p>

                <h3 id="item-description__features-overview"><?php echo __('Why upgrade to Premium Version of the plugin?', 'livemesh-bb-addons') ?></h3>
                ...
                <ul>
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/sliders/" title="Image Slider Addon" target="_blank">Image
                    ...
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/image-gallery/" title="Image Gallery Addon" target="_blank">Image
                            Gallery</a> - Create a gallery of images with options for masonry
                        or fit rows, pagination, lazy load, lightbox support etc.
                    </li>
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/video-gallery/" title="Video Gallery Addon" target="_blank">Video
                    ...
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/features/" title="Features Addon" target="_blank">Features Addon</a> - Showcase product features or services provided by your agency/business.
                    </li>
                </ul>
                ...
                <ul>
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/portfolio-grid-pro/" title="Livemesh Grid" target="_blank">Lazy Load</a> - The portfolio/post grid and image gallery addons
                ...
                <div class="button-wrap">
                    ...
                    <a class="button-wrap" href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Purchase Now">

                        <img class="button-image" style="border:none" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/purchase-button.png" alt="Purchase Button">
            ...
            <div class="panel-right">
                ...
                <div class="panel-inner">
                    ...
                    <div class="panel-aside banner">
                        <a href="https://www.livemeshthemes.com/beaver-builder-addons/pricing/" title="Purchase Now"><img class="dashboard-image" src="https://www.livemeshthemes.com/wp-content/uploads/plugin-doc/beaver-addons/dashboard/purchase-banner2.jpg" alt="Sale Banner"></a>
                    </div>
                    ...
                    <div class="panel-aside panel-sticky">
                        ...
                        <a class="button button-primary" href="https://www.livemeshthemes.com/beaver-builder-addons/contact-us/"
                           title="<?php esc_attr_e('Contact Us', 'livemesh-bb-addons'); ?>"><?php _e('Write to Us', 'livemesh-bb-addons'); ?></a>
